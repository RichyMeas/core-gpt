...
from src.utils.log_utils import print0, initalize_logging
...
def test_initalize_logging_creates_directory_and_logfile():
    # Mock os.makedirs, open, and csv.writer
    with patch("os.makedirs") as mock_makedirs, \
         patch("builtins.open", mock_open()) as mock_open_file, \
         patch("csv.writer") as mock_csv_writer, \
         patch("src.utils.log_utils.datetime") as mock_datetime, \
         patch("src.utils.log_utils.SummaryWriter") as mock_tb_writer:
